 ...
 */
export function ExpenseMetadataFields({ form, hasLowConfidence, groupMembers }: ExpenseMetadataFieldsProps) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      <ExpenseDateField form={form} hasLowConfidence={hasLowConfidence} />
      <ExpensePayerField form={form} hasLowConfidence={hasLowConfidence} groupMembers={groupMembers} />
    </div>
  );
}
