...
export const GoogleOAuthButton = memo(function GoogleOAuthButton({
  ...
  return (
    <Button
      type="button"
      variant="outline"
      className={`w-full rounded-xl border-2 border-gray-200 hover:border-primary bg-white transition-all duration-300 ease-out ${className || ""}`}
    ...
    >
      ...
      <span className="text-foreground font-medium">{buttonText}</span>
    </Button>
  );
});
